  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-[10%] -left-[10%] w-[70%] h-[60%] bg-purple-600/10 rounded-[40%] blur-3xl"></div>
        <div className="absolute -bottom-[20%] -right-[10%] w-[70%] h-[70%] bg-indigo-600/10 rounded-[40%] blur-3xl"></div>
        <div className="absolute top-[50%] right-[15%] w-[25%] h-[25%] bg-violet-500/10 rounded-[40%] blur-3xl"></div>
        <div className="absolute top-[20%] left-[50%] w-[15%] h-[15%] bg-fuchsia-500/10 rounded-[40%] blur-3xl"></div>
        <div className="hidden md:block absolute bottom-[10%] left-[20%] w-[30%] h-[30%] bg-blue-600/5 rounded-[40%] blur-3xl"></div>
